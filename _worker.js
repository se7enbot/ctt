...
export default {
  async fetch(request, env) {
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/se7enbot/ctt/refs/heads/main/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/se7enbot/ctt/refs/heads/main/CFTeleTrans/notification.md');
